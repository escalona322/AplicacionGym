      ...
      <div style="margin-top: 6em;">
        <div class="row" >
            ...
            <div   class="col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8">
                <div class="row">
                    <p class="textogymxl text-center">BORRAR ENTRENAMIENTOS </p>
                </div>
                <div class="container contenedorentrenos overflow-auto">
                  @foreach($entre as $entrenamiento)
                       ...
                       <div class="row fondoentrenos">
                         ...
                         <div class="col"><form class="" action="borrarEntrenos/{{$entrenamiento->id}}" method="get">
                           <button class="botonentrenos" type="submit" name="button">Eliminar</button>
                         </form></div>
                       </div>
