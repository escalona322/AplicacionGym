...
class EntrenamientoSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '12',
        'series' => '2',
        'videoyt'=> 'https://www.youtube.com/embed/Hh2hIJDGCz8',
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '10',
        'series' => '4',
        'videoyt'=>'https://www.youtube.com/embed/rUXE5JmNrKI',
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '15',
        'series' => '4',
        'videoyt'=>'https://www.youtube.com/embed/bxsjX_aRSaY',
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '10',
        'series' => '3',
        'videoyt'=>'https://www.youtube.com/embed/2eWtmRQdv88',
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '25',
        'series' => '3',
        'videoyt'=>'https://www.youtube.com/embed/1mStIPjEYqA',
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '50',
        'series' => '1',
        'videoyt'=>'https://www.youtube.com/embed/qap5Z1GfTW0',
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '10',
        'series' => '2',
        'videoyt'=>'https://www.youtube.com/embed/IYusabTdFEo',
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '10',
        'series' => '2',
        'videoyt'=>'https://www.youtube.com/embed/uGPINUVsRkI',
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '15',
        'series' => '4',
        'videoyt'=>'https://www.youtube.com/embed/T5E-qvzBjYc',
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '15',
        'series' => '4',
        'videoyt'=>'https://www.youtube.com/embed/wgpEj-jSq3A',
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '15',
        'series' => '3',
        'videoyt'=>'https://www.youtube.com/embed/V5JLXeNGvhg',
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '10',
        'series' => '2',
        'videoyt'=>'https://www.youtube.com/embed/TwXPklkR8ws',
      ...
      DB::table('entrenamientos')->insert([
        ...
        'repeticiones' => '14',
        'series' => '2',
        'videoyt'=>'https://www.youtube.com/embed/ANVdMDaYRts',
